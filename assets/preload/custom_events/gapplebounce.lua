...
function onUpdatePost()
 setProperty("iconP1.scale.y", (getProperty("iconP1.scale.y") - 1) / 0.4 + 1)
 setProperty("iconP2.scale.y", (getProperty("iconP2.scale.y") - 1) / 0.4 + 1)
 setProperty("iconP1.y", 496 + (getProperty("iconP1.scale.y") * 75))
 setProperty("iconP2.y", 496 + (getProperty("iconP2.scale.y") * 75))
 if getPropertyFromClass('ClientPrefs', 'downScroll') == true then
 setProperty("iconP1.y", -66 + (getProperty("iconP1.scale.y") * 75))
 setProperty("iconP2.y", -66 + (getProperty("iconP2.scale.y") * 75))
end
end